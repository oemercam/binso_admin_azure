...
function modeLabel(value: TimeTrackingPolicy['mode']) { return value === 'both' ? 'Binso One + Kundensystem' : value === 'internal' ? 'Binso One' : 'Kundensystem' }
