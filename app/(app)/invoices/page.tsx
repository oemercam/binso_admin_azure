      ...
      <div className="data-list">
        ...
        {store.invoices.map((invoice) => (
          <div className="data-row invoice-grid" key={invoice.id}>
            ...
            <span>{invoice.customerName}</span><span>{fmt(invoice.due)}</span><span><strong>{chf.format(invoice.amount)}</strong><small>{invoice.lines.length} Positionen</small></span><span className={`status ${effectiveInvoiceStatus(invoice)}`}>{invoiceStatusLabel(effectiveInvoiceStatus(invoice))}</span>
