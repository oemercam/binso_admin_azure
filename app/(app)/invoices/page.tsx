...
const emptyInvoiceLine = (): InvoiceLine => ({ id: `il-extra-${Date.now()}`, description: '', quantity: 1, unit: 'Stk.', unitPrice: 0, vatRate: 8.1, sourceTimeEntryIds: [] })
...
export default function InvoicesPage() {
  ...
  const [extraLines, setExtraLines] = useState<InvoiceLine[]>(() => [emptyInvoiceLine()])
  ...
  function createInvoice() {
    ...
    if (invoice) {
      ...
      setSelected([])
      setSelectedExpenses([])
      setExtraLines([emptyInvoiceLine()])
      setPreview(invoice)
    }
  }
