...
export async function PATCH(request: Request) {
  ...
  const body = await readJsonBody<{ grantId?: string; action?: 'approve' | 'activate' | 'revoke'; durationHours?: number }>(request, PRODUCT_LIMITS.apiBodyStandardBytes).catch(() => null)
