    ...
    <PublicShell>
      <main className="public-main public-main-narrow">
        ...
        <section className="public-security-list">
          <article><h2>Anmeldung</h2><p>Die produktive Benutzeranmeldung wird über Azure App Service Authentication und eine Microsoft-basierte Identitätsplattform abgewickelt. Binso One speichert keine Benutzerpasswörter.</p></article>
          ...
          <article><h2>Zahlungen</h2><p>Zahlungs- und Abonnementprozesse sind für Stripe Checkout, Kundenportal und sicher verarbeitete Zahlungsrückmeldungen vorbereitet.</p></article>
