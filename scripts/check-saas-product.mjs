...
const checks = [
  ...
  ['Organization navigation', nav.includes("href: '/organization'") || nav.includes('href: ROUTES.app.organization')],
  ['Data navigation', nav.includes("href: '/data'") || nav.includes('href: ROUTES.app.data')],
