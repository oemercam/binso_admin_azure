...
const invariants = [
  ...
  [signIn.includes("href={signInUrl('/post-login')}") && publicShell.includes('href="/sign-in"') && publicShell.includes('href="/register"'), 'public entry must keep sign-in and registration as distinct actions'],
