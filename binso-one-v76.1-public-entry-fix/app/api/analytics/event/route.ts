...
export async function POST(request:Request){
  ...
  const body=await readJsonBody<{eventName?:string;route?:string;entityType?:string;entityId?:string;metadata?:Record<string,string|number|boolean|null>}>(request,4096).catch(()=>null)
